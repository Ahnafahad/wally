...
const transactions = [
  ...
  T('rf03','2026-02-02','Shwapno Supermarket',2800,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rj11','2026-01-20','Transfer - Emergency Fund',5000,'transfer','Savings','rafiq-dutch-bangla'),
  ...
  T('rj16','2026-01-14','Meena Bazar',1800,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rj21','2026-01-06','Transfer - Laptop Fund',4000,'transfer','Savings','rafiq-dutch-bangla'),
  ...
  T('rd19','2025-12-05','Shwapno Supermarket',2450,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rn02','2025-11-28','Shwapno Supermarket',2100,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rn08','2025-11-05','Transfer - Emergency Fund',3000,'transfer','Savings','rafiq-dutch-bangla'),

  // ─── October 2025 ─────────────────────────────────────────────────────────
  T('ro01','2025-10-12','Salary Deposit',70000,'income','Salary','rafiq-brac'),
  T('ro02','2025-10-30','Meena Bazar',1950,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('ro07','2025-10-08','Transfer - Laptop Fund',4000,'transfer','Savings','rafiq-dutch-bangla'),
  ...
  T('rs08','2025-09-03','Transfer - Emergency Fund',2500,'transfer','Savings','rafiq-dutch-bangla'),

  // ─── August 2025 ──────────────────────────────────────────────────────────
  T('ra01','2025-08-12','Salary Deposit',70000,'income','Salary','rafiq-brac'),
  T('ra02','2025-08-28','Shwapno Supermarket',2300,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rj702','2025-07-30','Meena Bazar',1850,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rj707','2025-07-09','Transfer - Laptop Fund',3500,'transfer','Savings','rafiq-dutch-bangla'),
  ...
  T('rjn02','2025-06-28','Shwapno Supermarket',2050,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rm02','2025-05-28','Meena Bazar',1700,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rm06','2025-05-08','Transfer - Emergency Fund',2000,'transfer','Savings','rafiq-dutch-bangla'),
  ...
  T('rmr02','2025-03-29','Shwapno Supermarket',2400,'expense','Food & Dining','rafiq-dutch-bangla'),
  ...
  T('rmr07','2025-03-08','Transfer - Laptop Fund',5000,'transfer','Savings','rafiq-dutch-bangla'),
  ...
  T('rfb02','2025-02-27','Meena Bazar',1600,'expense','Food & Dining','rafiq-dutch-bangla'),
